...
echo ""
echo "2. 🌐 Get Render IP Addresses:"
echo "   - After deployment, contact Render support"
echo "   - Ask for IP addresses for custom domains"
echo "   - Or use DNS lookup: nslookup grafana-monitoring.onrender.com"
echo "   - Render typically uses: 76.76.19.x or 76.76.20.x"
echo ""
...
echo "   - Add A records (using IP addresses):"
echo "     * @ → RENDER_IP_ADDRESS"
echo "     * www → RENDER_IP_ADDRESS"
echo "   - Add CNAME records:"
echo "     * api → ai-service.onrender.com"
echo "     * prometheus → prometheus.onrender.com"
echo ""
echo "4. 🔧 Add Custom Domain in Render:"
...
echo "   - Root domain (@) requires IP address, not CNAME"
echo "   - Contact Render support for exact IP addresses"
