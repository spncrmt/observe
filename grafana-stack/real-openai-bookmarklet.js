// Real OpenAI AI Assistant Bookmarklet
...
javascript:(function(){
    ...
    title.style.cssText = `
        ...
        gap: 8px;
    `;
    title.innerHTML = '🤖 Real AI Assistant (OpenAI)';
    ...
    welcomeMessage.innerHTML = `
        ...
        <div><strong>Real OpenAI AI Assistant</strong></div>
        <div style="margin-top: 1rem; font-size: 0.9rem;">
            Powered by GPT-4 - I can create real dashboards, write PromQL queries, and analyze your metrics!
        </div>
    ...
    inputField.placeholder = 'Ask me anything about monitoring...';
    ...
    async function sendToAI(message) {
        try {
            ...
            return `❌ Error connecting to AI service: ${error.message}\n\nPlease check if the AI service is deployed and the OpenAI API key is set.`;
        }
    }
    ...
    // Success message
    console.log('🤖 Real OpenAI AI Assistant automatically injected! Press Ctrl+K to toggle.');
    ...
    `;
    notification.innerHTML = '🤖 Real OpenAI AI Assistant loaded! Press Ctrl+K to toggle.';
