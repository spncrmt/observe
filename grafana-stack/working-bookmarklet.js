// Working AI Assistant Bookmarklet - Self-contained
...
javascript:(function(){
    ...
    inputField.placeholder = 'Ask about your metrics, create dashboards, or analyze data...';
    ...
    inputForm.onsubmit = function(e) {
        ...
        if (message && !isLoading) {
            ...
            setTimeout(() => {
                addMessage(simulateAIResponse(message), false);
                isLoading = false;
