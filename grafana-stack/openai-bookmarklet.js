// OpenAI AI Assistant Bookmarklet
...
javascript:(function(){
    ...
    title.style.cssText = `
        ...
        gap: 8px;
    `;
    title.innerHTML = '🤖 AI Assistant (OpenAI)';
    ...
    welcomeMessage.innerHTML = `
        ...
        <div><strong>OpenAI-Powered AI Assistant</strong></div>
        <div style="margin-top: 1rem; font-size: 0.9rem;">
            I can create dashboards, write PromQL queries, and analyze your metrics!
        </div>
    ...
    // Success message
    console.log('🤖 OpenAI AI Assistant automatically injected! Press Ctrl+K to toggle.');
    ...
    `;
    notification.innerHTML = '🤖 OpenAI AI Assistant loaded! Press Ctrl+K to toggle.';
